	...
	class Admin_Settings {
		...
		public function init() {
			...
			add_settings_field(
				...
				__( 'Show quantity selector in configurator', 'product-configurator-for-woocommerce' ),
				[ $this, 'callback_checkbox' ],
				'mlk_pc_settings', 
				'general_settings',
				[ 
					'setting_name' => 'show_quantity_selector',
				]
			);

			add_settings_field(
				'show_save_design_button',
				__( 'Show Save Design button', 'product-configurator-for-woocommerce' ),
				[ $this, 'callback_checkbox' ],
				'mlk_pc_settings', 
				'general_settings',
				[ 
					'setting_name' => 'show_save_design_button',
				]
			);

			add_settings_field(
				'show_load_design_button',
				__( 'Show Load Design button', 'product-configurator-for-woocommerce' ),
				[ $this, 'callback_checkbox' ],
				'mlk_pc_settings', 
				'general_settings',
				[ 
					'setting_name' => 'show_load_design_button',
				]
			);

			add_settings_field(
				'show_share_design_button',
				__( 'Show Share Design button', 'product-configurator-for-woocommerce' ),
				[ $this, 'callback_checkbox' ],
				'mlk_pc_settings', 
				'general_settings',
				[ 
					'setting_name' => 'show_share_design_button',
				]
			);

			add_settings_field(
				'show_download_pdf_button',
				__( 'Show Download PDF button', 'product-configurator-for-woocommerce' ),
				[ $this, 'callback_checkbox' ],
				'mlk_pc_settings', 
				'general_settings',
				[ 
					'setting_name' => 'show_download_pdf_button',
				]
			);
		...
		public function display_addons() {
			...
			foreach( $this->addons as $addon ) {
				// All addons are now included - show all as installed
				$this->display_addon( $addon, true );
			}
